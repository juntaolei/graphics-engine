...
void
print_constants(struct constants* p)
{
  /*
  Print the given constants.

  @param: struct constants* p

  @return: void
  */
  printf(
    "\tRed -\t  Ka: %6.2f Kd: %6.2f Ks: %6.2f\n", p->r[0], p->r[1], p->r[2]);

  printf(
    "\tGreen -\t  Ka: %6.2f Kd: %6.2f Ks: %6.2f\n", p->g[0], p->g[1], p->g[2]);

  printf(
    "\tBlue -\t  Ka: %6.2f Kd: %6.2f Ks: %6.2f\n", p->b[0], p->b[1], p->b[2]);

  printf(
    "Red - %6.2f\tGreen - %6.2f\tBlue - %6.2f\n", p->red, p->green, p->blue);
}

void
print_light(struct light* p)
{
  /*
  Print the light values.

  @param: struct light* p
...
SYMTAB*
add_symbol(char* name, int type, void* data)
{
  /*
  Add a symbol.
...
void
set_value(SYMTAB* p, double value)
{
  /*
  Set a value for the symtab.
