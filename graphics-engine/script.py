import mdl
from display import (display, make_animation, new_screen, new_zbuffer,
                     save_extension)
from draw import *
from matrix import (ident, matrix_mult, make_rotX, make_rotY, make_rotZ,
                    make_scale, make_translate, new_matrix)
...
def first_pass(commands):
    ...
    if varyCheck and not frameCheck:
        ...
        print(
            "Animation code present but basename was not set. Using \"frame\" as basename."
        )
        name = "frame"
